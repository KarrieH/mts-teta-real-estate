...
print('coordinates', coordinates.loc[coordinates.state == a][['geo_lat', 'geo_lon', 'region']])

df['geo_lat'] = coordinates.loc[coordinates.state == a]['geo_lat'].values
df['geo_lon'] = coordinates.loc[coordinates.state == a]['geo_lon'].values
df['region'] = coordinates.loc[coordinates.state == a]['region'].values

#, 'geo_lon', 'region'] = coordinates.loc[coordinates.state == a][
   # ['geo_lat', 'geo_lon', 'region']]

print('DF', df[['geo_lat', 'geo_lon', 'region']])
